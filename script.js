...
function generateWorker(type, nameKey, fieldsAvailable) {
    fieldsAvailable = fieldsAvailable.split(',');
    WORKERS[type]   = data => {
        console.log(data);
        let result = {};
        for (let k in data) {
...
generateWorker('weapon', 'name', 'ammo_type,magazine_size,max_rounds,damage_scaling_min,damage_scaling_max');
